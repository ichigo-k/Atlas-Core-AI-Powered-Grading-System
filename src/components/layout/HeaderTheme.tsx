...
const THEMES: { id: ThemeId; label: string; Component: () => React.ReactElement }[] = [
          ...
          <div className="p-2 grid grid-cols-1 gap-1">
            {THEMES.map(({ id, label }) => (
              <button
                ...
                className={`flex items-center gap-2.5 px-2.5 py-2 rounded text-[12px] font-medium transition-colors text-left ${theme === id
