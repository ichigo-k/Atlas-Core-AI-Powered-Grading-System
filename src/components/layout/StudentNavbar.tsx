...
import { Calendar, ClipboardList, LayoutDashboard, LogOut, User } from "lucide-react";
          ...
          {navItems.map(({ label, href, Icon }) => {
            ...
            return (
              <Tooltip key={href}>
                ...
                <TooltipContent side="right" sideOffset={12} className="bg-black text-white border-none font-bold">
                  {label}
                </TooltipContent>
              </Tooltip>
            );
