    ...
    <div className="h-screen overflow-hidden bg-[#f8f9fa] dark:bg-[#0f1b2d] flex flex-col">
      ...
      <header className="h-12 flex-shrink-0 bg-primary dark:bg-[#002388] flex items-center gap-2 px-3 sm:px-4 z-50 relative overflow-hidden">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none" aria-hidden="true">
          <defs>
            <pattern id="kp-a" width="24" height="12" patternUnits="userSpaceOnUse">
          ...
          <rect width="100%" height="100%" fill="url(#kp-a)" opacity="0.09" />
        </svg>
        <button
          type="button"
        ...
        >
          ...
          <div className="hidden sm:block leading-tight">
            ...
            <div className="text-white/55 text-[9.5px]">Admin Console</div>
          </div>
        </Link>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          <AdminNavSidebar onClose={() => setMobileOpen(false)} />
        </div>
