	...
	return (
		...
		<div className="px-4 py-4 md:px-6 space-y-4 pb-12 max-w-[1280px]">
				...
				{tabs.map(({ key, label }) => {
					...
					return (
						...
						>
							{label}
							<span
								className={`flex items-center justify-center rounded px-1.5 py-0.5 text-[10px] font-bold transition-all ${
									active
								...
								<div>
									...
									<div className="flex flex-wrap gap-1.5">
										<button
											...
											className={`rounded-sm px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wider transition-all ${
												courseFilter === "all"
										...
										{courses.map((course) => (
											<button
												...
												className={`rounded-sm border px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wider transition-all ${
			...
			{filteredAssessments.length === 0 ? (
				...
				<div className="bg-white border border-border rounded-sm divide-y divide-[#f1f5f9]">
									...
									{isCompleted ? (
										...
										<div className="flex flex-col items-end gap-2">
											<Link
												...
												className={`flex items-center gap-1.5 rounded-sm px-4 py-2 text-[12px] font-semibold transition-all ${
													isOngoing
