...
type ClassOption = { id: number; name: string; level?: number | null };
					...
					<div className="h-full flex flex-col">
						...
						<div className="p-8 border-t border-slate-100 bg-slate-50/50 space-y-3">
							<Button
								type="button"
								variant="outline"
								className="w-full h-11 border-amber-200 bg-white text-amber-700 hover:bg-amber-50 hover:text-amber-800 font-bold rounded-sm transition-all flex items-center justify-center gap-2"
